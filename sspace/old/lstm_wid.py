...
def write_result(hidden_size,dens1_size, dens2_size):
    filename = '/home/nnabizad/code/toolpred/sspace/res/nomaskgru_lstm_{}_{}_{}.txt'.format(hidden_size, dens1_size, dens2_size)
    modelname = '/hri/localdisk/nnabizad/models/nomaskgru_h{}_d1{}_d2{}'.format(hidden_size, dens1_size, dens2_size)+ '_s{}'
