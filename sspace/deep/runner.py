...
import sys
models = [lstm_pred, lstm_sum, lstm_gru, lstm_sif, lstm_gru_zeroh, lstm_contcat]
...
def write_result(hidden_size, dens1_size, dens2_size):
    ...
    for seed in seeds:
        ...
        DataFrame(history.history).to_csv(
            '/home/nnabizad/code/toolpred/sspace/res/deeplog/extracted/{}_seed:{}_h1:{}_h2:{}_h3:{}.csv'.format(
