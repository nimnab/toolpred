...
class VariableSequenceLabelling:
    ...
    def prediction(self):
        ...
        tcell = rnn_cell.GRUCell(self._num_thidden)
        ...
        weight0, bias0 = self._weight_and_bias((self._num_thidden), tool_number)
        ...
        prediction = tf.reshape(prediction, [-1, max_length+1, num_classes])
        return prediction[:, 1: ,:]
